...
/***********************************************************/
	...
	public function createSubCategoria()
	{
		...
		if($salvar) {
			...
			$sql = $this->connect->prepare("INSERT INTO subcategorias (titulo, descricao, imagem, valor, id_categoria) VALUES (:titulo, :descricao, :imagem, :valor, :id_categoria)");
			...
			if ($sql->execute()) {
				...
				$diretorio = "../../img/categorias/subcategorias/" . $ultimo_id .'/';
...
/***********************************************************/
	...
	public function updateSubCategoria(){
		...
		$sql = $this->connect->prepare("UPDATE subcategorias SET id = :id, titulo = :titulo, descricao = :descricao, valor = :valor WHERE (id = :id)");
	...
	public function updateSubCategoriaImagem(){
		...
		$sql = $this->connect->prepare("UPDATE subcategorias SET id = :id, imagem = :imagem WHERE (id = :id)");
...
/***********************************************************/
	...
	public function listSubCategoriasId(){
		...
		$query = "SELECT * FROM subcategorias WHERE id_categoria='$id_get'";
		$result = $this->connect->prepare($query);
		$result->execute();
		return $result->fetchAll();
	}
	...
	public function listSubCategoriasIdUp(){
		...
		$query = "SELECT * FROM subcategorias WHERE id='$id_get'";
		$result = $this->connect->prepare($query);
		$result->execute();
		return $result->fetchAll();
	}
...
/***********************************************************/
	...
	public function deleteSubCategoria(){
		...
		$sql = $this->connect->prepare("DELETE FROM subcategorias WHERE (id = :id)");
