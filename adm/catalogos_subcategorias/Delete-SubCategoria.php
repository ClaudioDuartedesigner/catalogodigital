...
?>
	...
	<img src="<?php echo "../../img/catalogos_categorias/subcategorias/$id/$imagem"?>" class="img-box-categoria"> 
...
if(isset($_POST['id'])){
		...
		unlink('../../img/catalogos_categorias/subcategorias/'.$id.'/'.$imagem);
		rmdir('../../img/catalogos_categorias/subcategorias/'.$id);
	}
