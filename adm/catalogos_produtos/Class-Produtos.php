...
/***********************************************************/
	...
	public function createprodutos()
	{
		...
		if($salvar) {
			...
			$sql = $this->connect->prepare("INSERT INTO catalogos_produtos (titulo, descricao, imagem, local, id_subcategoria, whatsapp, link_catalogo) VALUES (:titulo, :descricao, :imagem, :local, :id_subcategoria, :whatsapp, :link_catalogo)");
			...
			if ($sql->execute()) {
				...
				$diretorio = "../../img/catalogos_categorias/subcategorias/produtos/" . $ultimo_id .'/';
...
/***********************************************************/
	...
	public function updateProdutos(){
		...
		$sql = $this->connect->prepare("UPDATE catalogos_produtos SET id = :id, titulo = :titulo, descricao = :descricao, local = :local, whatsapp = :whatsapp, link_catalogo = :link_catalogo WHERE (id = :id)");
	...
	public function updateProdutoImagem(){
		...
		$sql = $this->connect->prepare("UPDATE catalogos_produtos SET id = :id, imagem = :imagem WHERE (id = :id)");
...
/***********************************************************/
	...
	public function listProdutosId(){
		...
		$query = "SELECT * FROM catalogos_produtos WHERE id_subcategoria='$id_get'";
		$result = $this->connect->prepare($query);
		$result->execute();
		return $result->fetchAll();
	}
    ...
    public function listProdutosDuart(){


		$this->conn = $this->connect();

		$query = "SELECT * FROM catalogos_produtos WHERE id_subcategoria='42'";
		$result = $this->connect->prepare($query);
		$result->execute();
		return $result->fetchAll();
	}
    ...
    public function listProdutosDicas(){


		$this->conn = $this->connect();

		$query = "SELECT * FROM catalogos_produtos WHERE id_subcategoria='43'";
		$result = $this->connect->prepare($query);
		$result->execute();
		return $result->fetchAll();
	}
	...
	public function listProdutosIdUp(){
		...
		$query = "SELECT * FROM catalogos_produtos WHERE id='$id_get'";
		$result = $this->connect->prepare($query);
		$result->execute();
		return $result->fetchAll();
	}
...
/***********************************************************/
	...
	public function deleteProduto(){
		...
		$sql = $this->connect->prepare("DELETE FROM catalogos_produtos WHERE (id = :id)");
