...
?>
	...
	<img src="<?php echo "../../img/catalogos_categorias/subcategorias/produtos/$id/$imagem"?>" class="img-box-categoria"> 
...
if(isset($_POST['id'])){
		...
		unlink('../../img/catalogos_categorias/subcategorias/produtos/'.$id.'/'.$imagem);
		rmdir('../../img/catalogos_categorias/subcategorias/produtos/'.$id);
	}
